...
function Create() {
  ...
  //   setFormData({
  //     name: profile.mydetails?.[0]?.name || '',
  //     email: profile.mydetails?.[0]?.email || '',
  //     role: profile.mydetails?.[0]?.role || '',
  //     totalExp: profile.mydetails?.[0]?.totalExp || '',
  //     aboutme: profile.aboutme?.[0]?.about|| '',
  //     aboutme: profile.aboutme?.[0]?.aboutPoints|| '',
  //     skills: profile.skills?.[0]?.data?.catogory|| '',
  //     skills: profile.skills?.[0]?.data?.skills|| '',
  //     work: profile.work?.[0]?.client|| '',
  //     work: profile.work?.[0]?.country|| '',
  //     work: profile.work?.[0]?.projectName|| '',
  //     work: profile.work?.[0]?.roleWork|| '',
  //     work: profile.work?.[0]?.startDate|| '',
  //     work: profile.work?.[0]?.endDate|| '',
  //     work: profile.work?.[0]?.businessSolution|| '',
  //     work: profile.work?.[0]?.technologyStack|| '',
  //     work: profile.work?.[0]?.projectResponsibiliy|| '',
  ...
  const handleEdit = async (id, index) => {
    const dataToEdit = resumeProfiles[index];
    try {
